...
class Transactions
{
  public:
    struct Cols
    {
        ...
        static const std::string _id_account;
    ...
    /**  For column id_account  */
    ///Get the value of the column id_account, returns the default value if the column is null
    const int32_t &getValueOfIdAccount() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int32_t> &getIdAccount() const noexcept;
    ///Set the value of the column id_account
    void setIdAccount(const int32_t &pIdAccount) noexcept;
    ...
    void setIdCategoryToNull() noexcept;
  ...
  private:
    ...
    std::shared_ptr<int32_t> idAccount_;
